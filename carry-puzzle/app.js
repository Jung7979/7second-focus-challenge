...
function applyProductImage(element, piece) {
  ...
  const imagePath = piece.id === 'underwear' ? 'assets/pieces-full/underwear.jpg' : piece.id === 'shoes' ? 'assets/pieces-shaped/shoes-l-v2.png' : `assets/pieces-shaped/${piece.id}.png`;
